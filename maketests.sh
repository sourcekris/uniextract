...
echo -n "MSI test: "
e=msi && echo -n MSI > 0 && msibuild 0.$e -a 0 0 && gzip < 0.$e | base64 -w 0 && rm 0 0.$e && echo

echo -n "IHEX test: "
e=ihex && echo -n IHEX > 0 && objcopy -I binary 0 -O ihex 0.$e && gzip < 0.$e | base64 -w 0 && rm 0 0.$e && echo
