...
dosbox_test "arg" "ARG" "dosbox -c \"mount d $(pwd)\" -c \"mount e tools\" -c \"d:\" -c \"e:\\arg a 0.\$e 0\" -c \"exit\"" true
dosbox_test "lg" "ARHANGEL" "dosbox -c \"mount d $(pwd)\" -c \"mount e tools\" -c \"d:\" -c \"e:\\ARHANGEL a 0.\$e 0\" -c \"exit\"" true
